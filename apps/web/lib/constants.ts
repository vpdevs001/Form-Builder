...
export const FEATURES: Feature[] = [
  {
    ...
    badge: "Form Design",
    badgeColor: "orange",
    description: "Craft questions that collect exactly what you need. From standard text and email fields to star ratings, dropdown choices, and secure date pickers.",
  ...
  },
  {
    ...
    badge: "Visual Style",
    badgeColor: "red",
    description: "Break away from boring surveys. Skin your forms in legendary styles — from a Naruto parchment scroll to a Ryuk shinigami notebook or AoT military parchment.",
  ...
  },
  {
    ...
    badgeColor: "green",
    description: "Gain visual mastery over your data. View real-time submission volumes, visitor metrics, completion speeds, and detailed choice summaries with interactive charts.",
  ...
  },
  {
    ...
    badgeColor: "orange",
    description: "Deploy your forms instantly to the web. Get a short, dedicated sharing link and clean embed codes to collect data anywhere in the shinobi world.",
  ...
  },
  {
    ...
    badge: "Secure Access",
    badgeColor: "red",
    description: "Maintain absolute control over submissions. Restrict spam with IP rate-limiting, shield with passwords, set response quotas, or schedule expiration dates.",
  ...
  },
  {
    ...
    badgeColor: "green",
    description: "Never miss a beat. Configure immediate email notifications to trigger on every submission, or automatically email custom copy receipts to your respondents.",
...
export const ANIME_THEMES: AnimeTheme[] = [
  {
    ...
    description: "Draped in classic Naruto orange, dark navy accents, and warm parchment backgrounds. Features floating shuriken elements and warm chakra glows.",
    ...
    bgImage: "https://images.unsplash.com/photo-1618336753974-aae8e04506aa?auto=format&fit=crop&q=80&w=800", // stylised orange/dark background
  ...
  },
  {
    ...
    description: "A dark, gothic theme styled with Ryuk's signature apple crimson, obsidian black overlays, and stark typewriter fonts. Emits a dangerous dark red aura.",
    ...
    bgImage: "https://images.unsplash.com/photo-1509248961158-e54f6934749c?auto=format&fit=crop&q=80&w=800", // dark mist/gothic background
  ...
  },
  {
    ...
    description: "Styled with forest-emerald green from the Wings of Freedom capes, warm sand textures, and bold metallic borders. Features steel-blue accents.",
    ...
    bgImage: "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&q=80&w=800", // deep forest/wall background
