  ...
  return (
    <section className="py-24 relative overflow-hidden border-t border-primary/5">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl relative z-10">
        <div className="relative rounded-3xl p-8 sm:p-12 md:p-16 overflow-hidden bg-linear-to-br from-[#1a1005] via-[#0d0702] to-[#060913] border border-primary/20 shadow-[0_0_40px_rgba(255,107,0,0.15)] text-center scroll-animate">
          ...
          <p className="text-sm sm:text-base md:text-lg text-foreground/80 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
            Join the ranks of elite shinobi form builders. Skin your questions, set secure
            protections, and analyze responses with legendary aesthetics.
          </p>
